  ...
  const countryCardsHTML = countries.map(country => `
    <div class="bg-white rounded-lg shadow-md border hover:shadow-lg transition-all duration-300 p-6">
        ...
        <div class="flex items-center">
          ...
          <div>
            <h3 class="text-xl font-semibold text-gray-900 mb-1">
              <a href="${['usa', 'canada', 'australia', 'belgium', 'india', 'singapore', 'dubai', 'south-africa', 'philippines', 'pakistan', 'nepal'].includes(country.slug) ? '/countries/' + country.slug : '/brokers/' + country.slug}" class="hover:text-blue-600 transition-colors">
                ${country.name}
              </a>
            </h3>
      ...
      <div class="flex gap-2">
        <a href="${['usa', 'canada', 'australia', 'belgium', 'india', 'singapore', 'dubai', 'south-africa', 'philippines', 'pakistan', 'nepal'].includes(country.slug) ? '/countries/' + country.slug : '/brokers/' + country.slug}" 
