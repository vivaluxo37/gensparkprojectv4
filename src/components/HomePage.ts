import { renderProfessionalHero } from './ProfessionalHero.js';

export function renderHomePage(): string {
  return `
    ${renderProfessionalHero()}
    
    <!-- Original Hero Section (Hidden, replaced by professional hero) -->
    <section id="home" class="hero-section bg-gradient-to-br from-blue-600 via-blue-700 to-blue-900 text-white py-16 md:py-20 relative overflow-hidden hidden" role="banner">
